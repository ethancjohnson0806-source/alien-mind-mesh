...
from alien_mind_v10 import StructuredSemanticField
...
def main():
    ap = argparse.ArgumentParser(description="ghost_ai_node_v10.py — AI mind v10 on the ghost mesh")
    ...
    if args.load and os.path.exists("mind_v84.json"):
        field.load("mind_v84.json")
